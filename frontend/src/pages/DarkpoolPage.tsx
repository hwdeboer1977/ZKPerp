    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="grid md:grid-cols-3 gap-5 mb-12">
        {[
          ...
          },
          {
            ...
            body: 'Every match is verified on-chain by a zero-knowledge proof that enforces each order\'s limit price, escrowed deposit, and expiry — so the operator can\'t settle outside those bounds or fabricate a fill.',
          },
        ].map(({ icon, title, body }) => (
      ...
      <div className="bg-zkperp-card rounded-xl border border-zkperp-border p-6 mb-6">
        ...
        <div className="space-y-4">
          {[
            ...
            { step: '5', title: 'On-chain settlement', body: 'Aleo verifies the proof and executes settlement atomically. Unmatched orders are refunded. The operator can\'t settle outside your limit price, exceed your deposit, or replay an order — though it does choose which in-bounds orders are matched.' },
          ].map(({ step, title, body }) => (
      ...
      <div className="bg-zkperp-card rounded-xl border border-zkperp-border p-6 mb-6">
        ...
        <p className="text-sm text-gray-400 mb-3">
          A working proof of concept (<code className="text-zkperp-accent text-xs px-1 bg-zkperp-dark rounded">zkdarkpool_v9.aleo</code>) is already deployed on Aleo testnet with live batch auction settlement confirmed. The full UI integration is in progress.
        </p>
        <a
