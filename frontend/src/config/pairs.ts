...
export const ORACLE_PROGRAM_ID = 
  import.meta.env.VITE_ORACLE_PROGRAM_ID ?? 'zkperp_oracle_v4.aleo';
...
export const PAIRS: Record<PairId, PairConfig> = {
  btc: {
    ...
    label: 'BTC/USDC',
    baseAsset: 'BTC',
    programId: import.meta.env.VITE_PROGRAM_ID_BTC ?? 'zkperp_core_v30.aleo',
  ...
  eth: {
    ...
    label: 'ETH/USDC',
    baseAsset: 'ETH',
    programId: import.meta.env.VITE_PROGRAM_ID_ETH ?? 'zkperp_core_eth_v27.aleo',
  ...
  sol: {
    ...
    label: 'SOL/USDC',
    baseAsset: 'SOL',
    programId: import.meta.env.VITE_PROGRAM_ID_SOL ?? 'zkperp_core_sol_v27.aleo',
