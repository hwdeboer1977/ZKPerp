...
const COMPLIANCE_PROGRAM_ID = 'zkperp_compliance_v9.aleo';
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-zkperp-card rounded-xl border border-zkperp-border p-6 mb-6">
        ...
        <p className="text-sm text-gray-400 mb-4 leading-relaxed">
          ...
          <code className="text-zkperp-accent text-xs bg-zkperp-dark px-1.5 py-0.5 rounded">zkperp_core_v30.aleo</code>.
        </p>
